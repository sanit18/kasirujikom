...
<html lang="en">
  ...
  <body>
    <nav class="navbar  sticky-top  flex-md-nowrap p-0 shadow" style="color:pink">
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="index.php?page=home">Halaman Toko</a>
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
		<h1 class="h2">ABSOLUTE BEAUTY SHOP</h1>
	  </div>
    <?php
